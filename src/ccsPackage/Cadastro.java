 ...
 */
@Entity
@Table(name = "cadastro", catalog = "teste", schema = "")
@NamedQueries({
    ...
    @NamedQuery(name = "Cadastro.findByDescricao", query = "SELECT c FROM Cadastro c WHERE c.descricao = :descricao")})
public class Cadastro implements Serializable {
    ...
    public String toString() {
        return "ccsPackage.Cadastro[ codigo=" + codigo + " ]";
    }
